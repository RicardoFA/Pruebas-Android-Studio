package com.example.desarrollo.navigationdrawer;
...
FragmentGaleria.OnFragmentInteractionListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Log.i("NavigationDrawer", "Esta es la opcion SlideShow");
            getSupportActionBar().setTitle("SlideShow");

        } else if (id == R.id.nav_manage) {
            Log.i("NavigationDrawer", "Esta es la opcion NavManage");

        } else if (id == R.id.nav_share) {
            Log.i("NavigationDrawer", "Esta es la opcion NavShare");

        } else if (id == R.id.nav_send) {
            Log.i("NavigationDrawer", "Esta es la opcion Send");
